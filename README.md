...
> **Note:** this repo is a centralized portfolio, created after the weekly projects were submitted. The original individual repos, submitted for grading, remain unchanged and accessible separately.
...
**Contents:**
- `Employee_Attrition_Analysis.ipynb` — analysis notebook
- `Business_Understanding_Report.docx` — business understanding report
- `Dataset_Inspection_Report.docx` — dataset inspection report
- `Reflection_Report.docx` — reflection report
- `data/` — dataset used
...
**Contents:**
- `Heart_Disease_Preprocessing.ipynb` — preprocessing notebook
- `Business_Understanding_Report_Week2.docx` — business understanding report
- `Data_Preprocessing_Report.docx` — data preprocessing report
- `heart_cleaned.csv`, `heart_ml_ready.csv` — cleaned, ML-ready data
- `data/` — raw dataset
...
**Contents:**
- `Heart_Disease_Advanced_Analysis.ipynb` — 29 visualisations, 5 statistical tests, 5 engineered features
...
- `heart_final_ml_dataset.csv`, `heart_week3_reporting_dataset.csv`
...
**Contents:**
- `HealthConnect_ML_Problem_Definition.ipynb` — problem definition, target variable, candidate features, initial modelling approach
...
**Contents:**
- `HealthConnect_Baseline_Model.ipynb` — data prep, 5 engineered features, Logistic Regression + Random Forest baselines, evaluation
...
**Contents:**
- `HealthConnect_Model_Improvement.ipynb` — error analysis, feature refinement, model comparison, cross-track integration
- `Week6_Project_Summary.docx`
- `Data_Analytics_Collaboration_with_Data_Science_track.pdf` — findings received from Data Analytics
- `DataScience_Feedback_to_DataAnalytics.docx` / `.pdf` — feedback provided back

🔗 Original submitted repo: [analystlab-week2-heart-disease-analysis/week6](https://github.com/mairamesniang12/analystlab-week2-heart-disease-analysis/tree/main/week6)
